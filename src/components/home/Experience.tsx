...
const ExperienceCard: React.FC<ExperienceCardProps> = ({ experience: exp }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-[250px_1fr] bg-background group border-4 border-accent hover:shadow-[6px_6px_0_var(--color-foreground)] transition-all duration-300">
