    ...
    <section id="about" className="py-24 border-b-4 border-accent">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-16">
        <div className="relative h-fit group">
          <div className="inline-block p-4 border-4 border-accent rotate-0 shadow-[8px_8px_0_rgba(250,250,250,0.1)] group-hover:bg-accent group-hover:text-foreground group-hover:rotate-0 group-hover:scale-105 transition-all duration-200">
            <TerminalStartIcon />
